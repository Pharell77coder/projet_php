...
DATAPATH = 'components\\db\\database.db'
...
try:
    ...
    cur.execute("DROP TABLE IF EXISTS joueurs")
    ...
    cur.execute("INSERT INTO utilisateurs (pseudo, image) VALUES (?, ?)", ('Administrateur', 'https://preview.redd.it/yskvwi9v9oia1.jpg?auto=webp&s=7b26fb1e1d71283860cbdfda7a7a6b06397b40ba'))
    cur.execute("INSERT INTO utilisateurs (pseudo, image) VALUES (?, ?)", ('Pharell', 'https://pbs.twimg.com/media/FREjAjXXwAASCp7.jpg:large'))
    ...
    cur.execute("INSERT INTO matchs (date, domicile, exterieur, score_dom, score_ext, competition) VALUES (?, ?, ?, ?, ?, ?)", ('2024-05-22', 'Marseille', 'Paris-SG', '2', '3', 'Ligue 1'))
    cur.execute("INSERT INTO matchs (date, domicile, exterieur, score_dom, score_ext, competition) VALUES (?, ?, ?, ?, ?, ?)", ('2024-05-22', 'Lille', 'Lyon', '4', '3', 'Ligue 1'))
    cur.execute("INSERT INTO matchs (date, domicile, exterieur, score_dom, score_ext, competition) VALUES (?, ?, ?, ?, ?, ?)", ('2024-05-29', 'Paris-SG', 'Lille', '2', '0', 'Ligue 1'))
    cur.execute("INSERT INTO matchs (date, domicile, exterieur, score_dom, score_ext, competition) VALUES (?, ?, ?, ?, ?, ?)", ('2024-05-29', 'Lyon', 'Marseille',  '1', '2', 'Ligue 1'))
    cur.execute("INSERT INTO matchs (date, domicile, exterieur, score_dom, score_ext, competition) VALUES (?, ?, ?, ?, ?, ?)", ('2024-06-06', 'Lyon', 'Paris-SG',  '3', '2', 'Ligue 1'))
    cur.execute("INSERT INTO matchs (date, domicile, exterieur, score_dom, score_ext, competition) VALUES (?, ?, ?, ?, ?, ?)", ('2024-06-06', 'Lille', 'Marseille',  '0', '0', 'Ligue 1'))
