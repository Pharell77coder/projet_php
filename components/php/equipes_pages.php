...
<html lang="fr">
  ...
  ?>
    ...
    <main>
    <?php
    $query = "SELECT nom, federation, image, confederation FROM equipes";
    $data_equipes = select_from_table($query);

    $customer = new Equipe($data_equipes);
    $customer -> generateTableEquipes();
    ?>
    </main>
